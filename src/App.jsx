...
const STUDIO_CONFIG = {
  name: "MAVEN",
  subtitle: "YOGA",
  tagline: "Feel like a better human.",
  logoMark: "M",
  description: "Candlelit, heated power-vinyasa in the heart of Fremont. Challenging yet intelligent. Queer and BIPOC-owned.",
  heroLine1: "FEEL LIKE",
  heroLine2: "A BETTER HUMAN",
  address: { street: "3516 Fremont Pl N, Ste D", city: "Seattle", state: "WA", zip: "98103" },
  phone: "(206) 397-3619",
  email: "hello@maven-yoga.com",
  neighborhood: "Fremont, Seattle",
  website: "https://www.maven-yoga.com",
  social: { instagram: "@mavenyoga" },
  locations: [{ name: "Dubliner Building", type: "yoga" }],
  theme: {
    accent:     { h: 272, s: 56, l: 54 },
    accentAlt:  { h: 38,  s: 65, l: 52 },
    warning:    { h: 0,   s: 65, l: 52 },
    primary:    { h: 260, s: 18, l: 10 },
    surface:    { h: 270, s: 8,  l: 97 },
    surfaceDim: { h: 265, s: 6,  l: 93 },
  },
  features: {
...
const STUDIO_IMAGES = {
  home: "https://images.squarespace-cdn.com/content/v1/59b15e1ee45a7ce2046d2e55/1531781591201-9NWDW5Z4UQ83U8YMQBIF/_W8A8220.jpg?format=1500w",
  classes: "https://images.squarespace-cdn.com/content/v1/59b15e1ee45a7ce2046d2e55/1665007944732-8JX77AMMZ9XVJ629SM51/header3_R4.jpg?format=1500w",
  schedule: "https://images.squarespace-cdn.com/content/v1/59b15e1ee45a7ce2046d2e55/1665008042571-PL7MXW5I86NUWC20V6CX/header4.jpg?format=1500w",
  practice: "https://images.squarespace-cdn.com/content/v1/59b15e1ee45a7ce2046d2e55/1531781514756-BLQCTBRT7P0C81F5AKW3/_W8A8021.jpg?format=1500w",
  community: "https://images.squarespace-cdn.com/content/v1/59b15e1ee45a7ce2046d2e55/ae71113b-59d8-4e1c-ac1f-87eb261d9b9c/Connect.jpg?format=1500w",
  teachers: "https://images.squarespace-cdn.com/content/v1/59b15e1ee45a7ce2046d2e55/1655326217554-DEBXCNM5TO2RKOAMMLAO/kai-solo.jpg?format=1500w",
  events: "https://images.squarespace-cdn.com/content/v1/59b15e1ee45a7ce2046d2e55/1531780695299-JA0F52MQO8E8FB7Z9UGM/Events.png?format=1500w",
  membership: "https://images.squarespace-cdn.com/content/v1/59b15e1ee45a7ce2046d2e55/1665007730408-XZGXVQ5V0BA4XVSMD0EU/header1.jpg?format=1500w",
};

// Gradient fallbacks for pages without photos
const GRADIENTS = {
  home: `linear-gradient(135deg, hsl(272,56%,30%) 0%, hsl(272,56%,18%) 100%)`,
  classes: `linear-gradient(135deg, hsl(38,65%,32%) 0%, hsl(272,40%,20%) 100%)`,
  schedule: `linear-gradient(135deg, hsl(272,40%,25%) 0%, hsl(260,18%,12%) 100%)`,
  practice: `linear-gradient(135deg, hsl(260,30%,28%) 0%, hsl(272,56%,22%) 100%)`,
  community: `linear-gradient(135deg, hsl(38,65%,28%) 0%, hsl(260,18%,14%) 100%)`,
  teachers: `linear-gradient(135deg, hsl(272,56%,34%) 0%, hsl(260,18%,16%) 100%)`,
  events: `linear-gradient(135deg, hsl(0,65%,30%) 0%, hsl(272,40%,18%) 100%)`,
  membership: `linear-gradient(135deg, hsl(272,56%,28%) 0%, hsl(38,40%,22%) 100%)`,
};
...
const T = {
  ...
  text: "#1a1a22", textMuted: "#6b6580", textFaint: "#9590a8",
  border: "#ddd8e8", borderLight: "#eeeaf4",
};
...
const TEACHERS = [
  { id: "t1", firstName: "Kai", lastName: "Rivera", role: "Lead Teacher", certs: ["RYT-500", "Power Vinyasa Specialist"], specialties: ["Dynamic Power Flow", "Essential Power Flow", "Inversions"], yearsTeaching: 10, bio: "Kai brings energy and wisdom to every class. Frequently celebrated by Maven students as the standout teacher, their intentional flow sequences challenge and inspire while creating space for personal growth.", photo: "" },
  { id: "t2", firstName: "Kirsten", lastName: "Dahlhauser", role: "Teacher", certs: ["RYT-200", "CorePower Extensions Lead"], specialties: ["Essential Power Flow", "Slow Flow", "Hands-On Assists"], yearsTeaching: 8, bio: "A former CorePower Extensions lead and coach, Kirsten guides weekly power vinyasa classes with an emphasis on listening to your body. She provides a supportive yet challenging space for student customization.", photo: "" },
  { id: "t3", firstName: "Alison", lastName: "Torres", role: "Teacher", certs: ["RYT-200", "Yin Yoga Certified"], specialties: ["Maven Mellow", "Flow + Mellow", "Slow Flow"], yearsTeaching: 6, bio: "Alison specializes in the softer side of Maven. Her Maven Mellow and Flow + Mellow classes help students find deep release through patient holds and supported postures.", photo: "" },
  { id: "t4", firstName: "James", lastName: "Park", role: "Front Desk & Teacher", certs: ["RYT-200"], specialties: ["Essential Power Flow", "Slow Flow"], yearsTeaching: 4, bio: "Always welcoming and helpful at the front desk, James also leads Essential Power Flow and Slow Flow classes. He creates an approachable environment where everyone feels they belong.", photo: "" },
  { id: "t5", firstName: "Ferrah", lastName: "Osei", role: "Teacher", certs: ["RYT-500", "Trauma-Informed Yoga"], specialties: ["Dynamic Power Flow", "Essential Power Flow", "Body Positivity"], yearsTeaching: 7, bio: "Ferrah loves making classes a little spicy without going overboard. Known for keeping the heat just right and sequences that are challenging but never intimidating.", photo: "" },
  { id: "t6", firstName: "Sam", lastName: "Chen", role: "Teacher", certs: ["RYT-200"], specialties: ["Dynamic Power Flow", "Flow + Mellow", "Intentions"], yearsTeaching: 5, bio: "Sam brings thoughtful intentions, creative flows, and impeccable cueing to every practice. Students love the way she talks through every move with care and clarity.", photo: "" },
];

const TODAYS_FOCUS = {
  id: "focus-today", date: today, name: "Dynamic Power Flow", type: "DYNAMIC", style: "Dynamic Power", temp: "98\u00b0F", duration: 60,
  description: "A vigorous practice pushing your edge both physically and mentally. Complex sequences, layered transitions, and opportunities to explore advanced postures in a candlelit, moody room.",
  intention: "Lean into growth when you can. Rest and simplify when you need to. Both are the practice.",
  teacherTip: "The room runs hotter in the center. If the heat feels like too much, move toward the edges. Child's pose is always available.",
};

const PAST_PRACTICES = [
  { id: "p-y1", date: offsetDate(-1), name: "Essential Power Flow", type: "ESSENTIAL", style: "Essential Power", temp: "98\u00b0F", duration: 60, description: "Breath connection and the balance of movement and stillness. Accessible to all levels with options to simplify or amplify.", intention: "Find your own balance of challenge and ease." },
  { id: "p-y2", date: offsetDate(-2), name: "Maven Mellow", type: "MELLOW", style: "Maven Mellow", temp: "80\u00b0F", duration: 60, description: "Yin-based practice with poses held 3-5 minutes targeting hips, pelvis, and spine. Deep connective tissue release.", intention: "Surrender is a form of strength." },
  { id: "p-y3", date: offsetDate(-3), name: "Slow Flow", type: "SLOW", style: "Slow Flow", temp: "93\u00b0F", duration: 60, description: "Slower paced, heated, with longer holds and softer edges. Plenty of opportunity to go deep.", intention: "Slow down to feel everything." },
];

const UPCOMING_PRACTICE = { id: "p-tmrw", date: offsetDate(1), name: "Flow + Mellow", type: "FLOW_MELLOW", style: "Flow + Mellow", temp: "90\u00b0F", duration: 75, description: "Best of both worlds. First half ignites breath and energy. Second half implements slow, patient holds with blocks, straps, and bolsters for deep release.", intention: "Move with fire. Rest with intention. Both are medicine." };

const CLASSES_TODAY = [
  { id: "cl1", time: "06:00", type: "Essential Power Flow", coach: "Kai Rivera", capacity: 30, registered: 26, waitlist: 0, location: "Dubliner Building" },
  { id: "cl2", time: "08:00", type: "Dynamic Power Flow", coach: "Ferrah Osei", capacity: 30, registered: 30, waitlist: 3, location: "Dubliner Building" },
  { id: "cl3", time: "09:30", type: "Slow Flow", coach: "Kirsten Dahlhauser", capacity: 30, registered: 22, waitlist: 0, location: "Dubliner Building" },
  { id: "cl4", time: "12:00", type: "Essential Power Flow", coach: "Sam Chen", capacity: 30, registered: 14, waitlist: 0, location: "Dubliner Building" },
  { id: "cl5", time: "16:30", type: "Dynamic Power Flow", coach: "Kai Rivera", capacity: 30, registered: 28, waitlist: 0, location: "Dubliner Building" },
  { id: "cl6", time: "17:45", type: "Flow + Mellow", coach: "Alison Torres", capacity: 30, registered: 24, waitlist: 0, location: "Dubliner Building" },
  { id: "cl7", time: "19:15", type: "Maven Mellow", coach: "Alison Torres", capacity: 30, registered: 18, waitlist: 0, location: "Dubliner Building" },
];

const WEEKLY_SCHEDULE = [
  { day: "Monday", classes: [{ time: "06:00", type: "Essential Power Flow", coach: "Kai" }, { time: "08:00", type: "Dynamic Power Flow", coach: "Ferrah" }, { time: "09:30", type: "Slow Flow", coach: "Kirsten" }, { time: "12:00", type: "Essential Power Flow", coach: "Sam" }, { time: "16:30", type: "Dynamic Power Flow", coach: "Kai" }, { time: "17:45", type: "Flow + Mellow", coach: "Alison" }, { time: "19:15", type: "Maven Mellow", coach: "Alison" }] },
  { day: "Tuesday", classes: [{ time: "06:00", type: "Essential Power Flow", coach: "Kai" }, { time: "08:00", type: "Dynamic Power Flow", coach: "Ferrah" }, { time: "09:30", type: "Slow Flow", coach: "Kirsten" }, { time: "12:00", type: "Essential Power Flow", coach: "Sam" }, { time: "16:30", type: "Dynamic Power Flow", coach: "Kai" }, { time: "17:45", type: "Flow + Mellow", coach: "Alison" }, { time: "19:15", type: "Maven Mellow", coach: "Alison" }] },
  { day: "Wednesday", classes: [{ time: "06:00", type: "Essential Power Flow", coach: "Kai" }, { time: "08:00", type: "Dynamic Power Flow", coach: "Ferrah" }, { time: "09:30", type: "Slow Flow", coach: "Kirsten" }, { time: "12:00", type: "Essential Power Flow", coach: "Sam" }, { time: "16:30", type: "Dynamic Power Flow", coach: "Kai" }, { time: "17:45", type: "Flow + Mellow", coach: "Alison" }, { time: "19:15", type: "Maven Mellow", coach: "Alison" }] },
  { day: "Thursday", classes: [{ time: "06:00", type: "Essential Power Flow", coach: "Kai" }, { time: "08:00", type: "Dynamic Power Flow", coach: "Ferrah" }, { time: "09:30", type: "Slow Flow", coach: "Kirsten" }, { time: "12:00", type: "Essential Power Flow", coach: "Sam" }, { time: "16:30", type: "Dynamic Power Flow", coach: "Kai" }, { time: "17:45", type: "Flow + Mellow", coach: "Alison" }, { time: "19:15", type: "Maven Mellow", coach: "Alison" }] },
  { day: "Friday", classes: [{ time: "06:00", type: "Essential Power Flow", coach: "Kai" }, { time: "08:00", type: "Dynamic Power Flow", coach: "Ferrah" }, { time: "09:30", type: "Slow Flow", coach: "Kirsten" }, { time: "12:00", type: "Essential Power Flow", coach: "Sam" }, { time: "16:30", type: "Flow + Mellow", coach: "Alison" }] },
  { day: "Saturday", classes: [{ time: "08:00", type: "Dynamic Power Flow", coach: "Kai" }, { time: "09:30", type: "Slow Flow", coach: "Kirsten" }, { time: "11:00", type: "Essential Power Flow", coach: "James" }, { time: "12:30", type: "Maven Mellow", coach: "Alison" }, { time: "16:30", type: "Flow + Mellow", coach: "Sam" }] },
  { day: "Sunday", classes: [{ time: "08:00", type: "Dynamic Power Flow", coach: "Kai" }, { time: "09:30", type: "Slow Flow", coach: "Kirsten" }, { time: "11:00", type: "Essential Power Flow", coach: "James" }, { time: "12:30", type: "Maven Mellow", coach: "Alison" }, { time: "16:30", type: "Flow + Mellow", coach: "Sam" }] },
];

const COMMUNITY_FEED = [
  { id: "cf1", user: "Jess T.", milestone: "First Dynamic Power", message: "Finally made it through Dynamic without sitting out a single flow. This studio makes you believe you can do hard things.", date: today, celebrations: 22 },
  { id: "cf2", user: "Alex M.", milestone: "100 Classes", message: "Triple digits at Maven. Every class I leave feeling like a better human. That is not a marketing line.", date: today, celebrations: 31 },
  { id: "cf3", user: "Devon R.", milestone: "30-Day Streak", message: "Thirty consecutive days on the mat. The 6am crew knows. The candlelight hits different before sunrise.", date: offsetDate(-1), celebrations: 19 },
  { id: "cf4", user: "Priya L.", milestone: "1 Year Member", message: "One year at Maven. I came for the yoga. I stayed for the community. This space is home.", date: offsetDate(-2), celebrations: 44 },
];
...
const MILESTONE_BADGES = {
  ...
  "First Dynamic Power": { icon: Zap, color: "#8b5cf6" },
  "First Mellow": { icon: Moon, color: "#3b82f6" },
  "1 Year Member": { icon: Award, color: T.success },
};

const EVENTS = [
  { id: "ev1", name: "Yoga School Collab: 200HR Teacher Training", date: "2026-09-12", startTime: "16:00", type: "Training", description: "A joint training between Maven Yoga and SOL Yoga. Six intensive weekends exploring the yogic arts with 40+ years of combined teaching experience. 5 BIPOC spaces at 50% off.", fee: 3200, maxParticipants: 20, registered: 12, status: "Registration Open" },
  { id: "ev2", name: "Maven Community Night", date: "2026-05-22", startTime: "18:00", type: "Community Event", description: "Extended candlelit power flow followed by community hang. Music, refreshments, and good energy in the Dubliner Building.", fee: 20, maxParticipants: 40, registered: 28, status: "Open" },
  { id: "ev3", name: "Summer Solstice Power Flow", date: "2026-06-20", startTime: "18:00", type: "Special Class", description: "A 90-minute Dynamic Power Flow celebrating the longest day. The room will be at full heat. Bring water and your strongest intention.", fee: 35, maxParticipants: 35, registered: 18, status: "Registration Open" },
];

const MEMBERSHIP_TIERS = [
  { id: "m0", name: "21-Day Intro", type: "intro", price: 55, period: "21 days", features: ["Unlimited classes for 21 days", "All class types included", "First-time Seattle residents only", "Best way to try Maven"], popular: false },
  { id: "m1", name: "Drop-In", type: "drop-in", price: 35, period: "per class", features: ["Single class credit", "Any class type", "Mats and towels available to rent"], popular: false },
  { id: "m2", name: "5-Class Monthly", type: "pack", price: 100, period: "/month", features: ["5 classes per month", "Auto-renewing subscription", "Any class type", "Great for 1-2x/week"], popular: false },
  { id: "m3", name: "Maven Unlimited", type: "unlimited", price: 140, period: "/month", features: ["Unlimited in-studio classes", "All 5 class types", "Auto-renewing subscription", "Priority booking", "10% off for students, BIPOC, LGBTQ+, 55+"], popular: true },
  { id: "m4", name: "10-Class Pack", type: "pack", price: 300, period: "10 classes", features: ["10 class credits", "Non-renewing", "Flexible scheduling", "Any class type"], popular: false },
];

const ANNOUNCEMENTS = [
  { id: "a1", title: "21-Day Intro Special: $55", message: "New to Maven? Try us for 21 consecutive days of unlimited yoga. All class types. All teachers. See if we are the right fit.", type: "celebration", pinned: true },
  { id: "a2", title: "Yoga School Collab Enrollment Open", message: "200HR teacher training with Maven Yoga and SOL Yoga. Six weekends. Five BIPOC spaces at 50% off. Starts September.", type: "info", pinned: false },
];

const MEMBERS_DATA = [
  { id: "mem1", name: "Jess Tanaka", email: "jess@email.com", membership: "Maven Unlimited", status: "active", joined: "2024-08-15", checkIns: 186, lastVisit: today },
  { id: "mem2", name: "Alex Morrison", email: "alex@email.com", membership: "Maven Unlimited", status: "active", joined: "2023-11-01", checkIns: 312, lastVisit: offsetDate(-1) },
  { id: "mem3", name: "Devon Reeves", email: "devon@email.com", membership: "10-Class Pack", status: "active", joined: "2026-01-15", checkIns: 6, lastVisit: offsetDate(-3) },
  { id: "mem4", name: "Priya Lakshmi", email: "priya@email.com", membership: "Maven Unlimited", status: "active", joined: "2025-04-01", checkIns: 156, lastVisit: today },
  { id: "mem5", name: "Casey Nguyen", email: "casey@email.com", membership: "5-Class Monthly", status: "frozen", joined: "2025-06-01", checkIns: 42, lastVisit: offsetDate(-22) },
  { id: "mem6", name: "Jordan Bell", email: "jordan@email.com", membership: "21-Day Intro", status: "active", joined: "2026-04-01", checkIns: 8, lastVisit: offsetDate(-1) },
];

const ADMIN_METRICS = { activeMembers: 118, memberChange: 7, todayCheckIns: 48, weekCheckIns: 286, monthlyRevenue: 16800, revenueChange: 7.4, renewalRate: 86.5, workshopRevenue: 1800 };

const ADMIN_CHARTS = {
  attendance: [
    { day: "Mon", total: 52, avg: 7 }, { day: "Tue", total: 48, avg: 7 },
    { day: "Wed", total: 44, avg: 6 }, { day: "Thu", total: 50, avg: 7 },
    { day: "Fri", total: 38, avg: 8 }, { day: "Sat", total: 58, avg: 12 },
    { day: "Sun", total: 42, avg: 8 },
  ],
  revenue: [
    { month: "Sep", revenue: 13200 }, { month: "Oct", revenue: 13800 },
    { month: "Nov", revenue: 14600 }, { month: "Dec", revenue: 13400 },
    { month: "Jan", revenue: 15200 }, { month: "Feb", revenue: 16000 },
    { month: "Mar", revenue: 16800 },
  ],
  classPopularity: [
    { name: "6:00 AM", pct: 88 }, { name: "8:00 AM", pct: 98 },
    { name: "9:30 AM", pct: 74 }, { name: "12:00 PM", pct: 48 },
    { name: "4:30 PM", pct: 92 }, { name: "5:45 PM", pct: 82 },
    { name: "7:15 PM", pct: 62 },
  ],
  membershipBreakdown: [
    { name: "Maven Unlimited", value: 52, color: T.accent },
    { name: "5-Class Monthly", value: 22, color: T.success },
    { name: "10-Class Pack", value: 18, color: T.warning },
    { name: "Drop-In / Intro", value: 26, color: T.textMuted },
  ],
};
...
function TeacherAvatar({ teacher, size = 56 }) {
  ...
  return (
    <div style={{ width: size, height: size, borderRadius: size > 48 ? 14 : 10, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Darker Grotesque', serif", fontSize: size * 0.38, color: "#fff", flexShrink: 0, fontWeight: 600 }}>
...
function SectionHeader({ title, linkText, linkPage }) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, padding: "0 16px" }}>
      <h2 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 24, margin: 0, fontWeight: 600 }}>{title}</h2>
    ...
    <div onClick={onToggle} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderLeft: `4px solid ${typeColors[practice.type] || T.accent}`, borderRadius: 12, padding: isFeatured ? "18px 18px" : "14px 16px", cursor: onToggle ? "pointer" : "default" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: isExpanded ? 10 : 0 }}>
        <div>
          ...
          <h3 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: isFeatured ? 26 : 20, margin: 0, color: T.text, fontWeight: 600 }}>{practice.name}</h3>
        </div>
...
function StatBox({ label, value }) {
  return (
    <div style={{ background: T.bgDim, borderRadius: 8, padding: "10px 12px", textAlign: "center" }}>
      ...
      <p style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 22, color: T.text, margin: 0, fontWeight: 700 }}>{value}</p>
    </div>
  );
}
...
function AdminCard({ title, children }) {
  return (
    <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
      <h3 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 18, color: "#1a1a22", margin: "0 0 14px", fontWeight: 600 }}>{title}</h3>
      {children}
    </div>
  );
}
    ...
    <div>
            ...
            return (
              <div key={c.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 48 }}>
                  <span style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 22, color: T.text, fontWeight: 600 }}>{fmtTime(c.time).split(":")[0]}</span>
      ...
      {ANNOUNCEMENTS.length > 0 && (
        <section style={{ marginTop: 28, padding: "0 16px" }}>
          <h2 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 24, margin: "0 0 12px", fontWeight: 600 }}>Announcements</h2>
      ...
      <section style={{ padding: "16px 16px 8px", marginTop: 20 }}>
        <div style={{ background: `linear-gradient(165deg, ${T.bg}, hsl(30,20%,14%))`, borderRadius: 16, padding: "24px 20px", color: "#fff", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative" }}>
            <h3 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 24, margin: "0 0 6px", fontWeight: 600 }}>New to Maven Yoga?</h3>
            <p style={{ fontSize: 13, color: "#b8a898", margin: "0 0 16px", lineHeight: 1.5 }}>Try us for 21 days unlimited for just $55. Five class types. Candlelit and heated.</p>
            <button onClick={() => {}} style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "10px 20px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontFamily: "'Darker Grotesque', serif", fontSize: 15, cursor: "pointer", fontWeight: 600 }}>View Memberships <ChevronRight size={16} /></button>
          </div>
        </div>
      </section>
    </div>
      ...
      <div style={{ padding: "16px 16px 0" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {WEEKLY_SCHEDULE[selectedDay]?.classes.map((cls, i) => {
            const isSpecial = cls.type.includes("Mellow") || cls.type.includes("Flow + Mellow");
            return (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 54 }}>
                  <span style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 16, color: T.text, fontWeight: 600 }}>{fmtTime(cls.time)}</span>
                </div>
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    <p style={{ fontWeight: 600, fontSize: 13, color: T.text, margin: 0 }}>{cls.type}</p>
                    {isSpecial && <span style={{ fontSize: 9, fontWeight: 700, textTransform: "uppercase", padding: "1px 5px", borderRadius: 4, background: T.warningGhost, color: T.warning }}>Mellow</span>}
                  </div>
                  <p style={{ fontSize: 11, color: T.textMuted, margin: "2px 0 0" }}>{cls.coach} — Dubliner Building</p>
                </div>
                <button onClick={() => openReservation({ id: `sched-${selectedDay}-${i}`, time: cls.time, type: cls.type, coach: cls.coach || "TBD", location: "Dubliner Building", capacity: isSpecial ? STUDIO_CONFIG.specialtyCapacity : STUDIO_CONFIG.classCapacity, registered: Math.floor(Math.random() * 10) + 15, waitlist: 0, dayLabel: dayNames[selectedDay] })} style={{ padding: "8px 14px", borderRadius: 8, border: "none", fontSize: 12, fontWeight: 600, cursor: "pointer", background: T.accent, color: "#fff" }}>Reserve</button>
              </div>
            );
          })}
        </div>
    ...
    <div>
      ...
      <div style={{ padding: "16px 16px 0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 20 }}>
          {[
            ...
            <div key={i} style={{ background: s.ghost, border: `1px solid ${s.bdr}`, borderRadius: 12, padding: "14px 10px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, fontWeight: 700, color: T.text }}>{s.val}</div>
        ...
        {activeTab === "log" && (
          <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12, padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button onClick={() => { setSaved(true); setTimeout(() => setSaved(null), 2000); setReflection({ energy: 4, focus: 4, notes: "" }); }} style={{ padding: "12px 0", borderRadius: 8, border: "none", fontWeight: 700, cursor: "pointer", background: T.accent, color: "#fff", fontFamily: "'Darker Grotesque', serif", fontSize: 17 }}>
        ...
        <div style={{ marginTop: 24 }}>
          <h3 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 22, margin: "0 0 12px", fontWeight: 600 }}>Recent Practice</h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              { date: today, name: "Dynamic Power Flow", result: "60 min", badge: "hot", icon: Sun, color: T.warning, ghost: T.warningGhost },
              { date: offsetDate(-1), name: "Essential Power Flow", result: "60 min", badge: "power", icon: Flame, color: T.accent, ghost: T.accentGhost },
              { date: offsetDate(-2), name: "Maven Mellow", result: "60 min", badge: "rest", icon: Moon, color: "#8b5cf6", ghost: "#8b5cf610" },
            ].map((h, i) => (
            ...
            return (
              <div key={item.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, padding: "16px 18px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  <div style={{ width: 40, height: 40, borderRadius: "50%", background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Darker Grotesque', serif", fontSize: 16, color: "#fff", fontWeight: 700, flexShrink: 0 }}>{item.user[0]}</div>
      ...
      <div style={{ padding: "16px 16px 0", display: "flex", flexDirection: "column", gap: 12 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: T.bgCard, border: `1px solid ${tier.popular ? T.accent : T.border}`, borderRadius: 14, padding: "20px 18px", position: "relative", overflow: "hidden" }}>
            ...
            <h3 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 22, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 12 }}>
              <span style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 38, color: T.accent, fontWeight: 700 }}>${tier.price}</span>
            ...
            <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Darker Grotesque', serif", background: tier.popular ? T.accent : T.bg, color: "#fff" }}>Get Started</button>
          </div>
        ))}
      </div>
    </div>
        ...
        {EVENTS.map(ev => (
          <div key={ev.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, overflow: "hidden", marginBottom: 16 }}>
            <div style={{ background: `linear-gradient(135deg, ${T.bg}, hsl(30,20%,14%))`, padding: "20px 18px", color: "#fff" }}>
              ...
              <h3 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 20, margin: "6px 0 4px", fontWeight: 600 }}>{ev.name}</h3>
            ...
            <div style={{ padding: "16px 18px" }}>
              ...
              <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Darker Grotesque', serif", background: T.accent, color: "#fff" }}>Register Now</button>
            </div>
          </div>
        ))}
      </div>
...
function AdminDashboard() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div><h1 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, color: "#1a1a22", margin: 0, fontWeight: 600 }}>Dashboard</h1><p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 0" }}>Welcome back. Here is what is happening at Maven Yoga.</p></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14 }}>
        {metrics.map((m, i) => (
          <div key={i} style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 30, color: "#1a1a22", fontWeight: 700 }}>{m.value}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 14 }}>
        <AdminCard title="Weekly Attendance"><div style={{ height: 220 }}><ResponsiveContainer width="100%" height="100%"><BarChart data={ADMIN_CHARTS.attendance}><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" /><XAxis dataKey="day" stroke="#6b7280" fontSize={12} /><YAxis stroke="#6b7280" fontSize={12} /><Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a22" }} /><Bar dataKey="total" fill={T.accent} radius={[4, 4, 0, 0]} /></BarChart></ResponsiveContainer></div></AdminCard>
        <AdminCard title="Revenue Trend"><div style={{ height: 220 }}><ResponsiveContainer width="100%" height="100%"><AreaChart data={ADMIN_CHARTS.revenue}><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" /><XAxis dataKey="month" stroke="#6b7280" fontSize={12} /><YAxis stroke="#6b7280" fontSize={12} tickFormatter={v => `$${v / 1000}k`} /><Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a22" }} formatter={(v) => [`$${v.toLocaleString()}`, "Revenue"]} /><defs><linearGradient id="revGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor={T.accent} stopOpacity={0.3} /><stop offset="100%" stopColor={T.accent} stopOpacity={0} /></linearGradient></defs><Area type="monotone" dataKey="revenue" stroke={T.accent} fill="url(#revGrad)" /></AreaChart></ResponsiveContainer></div></AdminCard>
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14 }}>
        <AdminCard title="Membership Breakdown">
          <div style={{ height: 200, display: "flex", alignItems: "center", justifyContent: "center" }}><ResponsiveContainer width="100%" height="100%"><PieChart><Pie data={ADMIN_CHARTS.membershipBreakdown} cx="50%" cy="50%" innerRadius={50} outerRadius={80} dataKey="value" paddingAngle={4}>{ADMIN_CHARTS.membershipBreakdown.map((e, i) => <Cell key={i} fill={e.color} />)}</Pie><Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a22" }} /></PieChart></ResponsiveContainer></div>
        ...
        <AdminCard title="Class Popularity (% Capacity)"><div style={{ height: 210 }}><ResponsiveContainer width="100%" height="100%"><BarChart data={ADMIN_CHARTS.classPopularity} layout="vertical"><CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" horizontal={false} /><XAxis type="number" stroke="#6b7280" fontSize={12} domain={[0, 100]} /><YAxis type="category" dataKey="name" stroke="#6b7280" fontSize={11} width={60} /><Tooltip contentStyle={{ backgroundColor: "#fff", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a22" }} formatter={v => [`${v}%`, "Capacity"]} /><Bar dataKey="pct" fill={T.accent} radius={[0, 4, 4, 0]} /></BarChart></ResponsiveContainer></div></AdminCard>
        <AdminCard title="Recent Activity">
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[{ text: "New member signup", detail: "Jordan Bell - 21-Day Intro", time: "5 min ago", color: T.accent },{ text: "Workshop registration", detail: "Summer Solstice Flow - Devon R.", time: "12 min ago", color: "#8b5cf6" },{ text: "Class waitlist full", detail: "8:00 AM Dynamic Power Flow", time: "18 min ago", color: T.success },{ text: "Payment received", detail: "Maven Unlimited - Jess Tanaka", time: "25 min ago", color: T.warning },{ text: "Guest pass redeemed", detail: "Jess Tanaka's guest", time: "1 hr ago", color: "#3b82f6" }].map((a, i) => (
...
function AdminMembersPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, color: "#1a1a22", margin: 0, fontWeight: 600 }}>Members</h1><CrudBar addLabel="Add Member" /></div>
      <div style={{ display: "flex", gap: 10 }}>
        <div style={{ flex: 1, position: "relative" }}><Search size={16} style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "#9ca3af" }} /><input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search members..." style={{ width: "100%", padding: "10px 12px 10px 36px", background: "#f9fafb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a22", fontSize: 13, outline: "none", boxSizing: "border-box" }} /></div>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          ...
          <tbody>{filtered.map(m => (
            <tr key={m.id} style={{ borderBottom: "1px solid #e5e7eb" }}>
              <td style={{ padding: "12px 16px" }}><p style={{ color: "#1a1a22", fontWeight: 600, margin: 0 }}>{m.name}</p><p style={{ color: "#9ca3af", fontSize: 12, margin: "2px 0 0" }}>{m.email}</p></td>
...
function AdminSchedulePage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, color: "#1a1a22", margin: 0, fontWeight: 600 }}>Schedule</h1><CrudBar addLabel="Add Class" /></div>
      <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, overflow: "hidden" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          ...
          <tbody>{CLASSES_TODAY.map(c => (
            <tr key={c.id} style={{ borderBottom: "1px solid #e5e7eb" }}>
              <td style={{ padding: "12px 14px", color: "#1a1a22", fontFamily: "monospace" }}>{fmtTime(c.time)}</td>
              <td style={{ padding: "12px 14px", color: "#374151", fontWeight: 600 }}>{c.type}</td>
              <td style={{ padding: "12px 14px", color: "#374151" }}>{c.coach}</td>
              <td style={{ padding: "12px 14px", color: "#6b7280", fontSize: 12 }}>Dubliner Building</td>
...
function AdminTeachersPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, color: "#1a1a22", margin: 0, fontWeight: 600 }}>Teachers</h1><CrudBar addLabel="Add Teacher" /></div>
        ...
        {TEACHERS.map(t => (
          <div key={t.id} style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
              ...
              <div><h3 style={{ fontSize: 15, fontWeight: 700, color: "#1a1a22", margin: 0 }}>{t.firstName} {t.lastName}</h3><p style={{ fontSize: 12, color: T.accent, fontWeight: 600, margin: "2px 0 0" }}>{t.role}</p></div>
            </div>
...
function AdminEventsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, color: "#1a1a22", margin: 0, fontWeight: 600 }}>Events & Workshops</h1><CrudBar addLabel="New Event" /></div>
      {EVENTS.map(ev => (
        <div key={ev.id} style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              ...
              <h3 style={{ fontSize: 18, fontWeight: 700, color: "#1a1a22", margin: "8px 0 4px" }}>{ev.name}</h3>
              <p style={{ fontSize: 13, color: "#6b7280" }}>{formatDateShort(ev.date)} — {ev.type} — ${ev.fee}</p>
            </div>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
              <div style={{ textAlign: "right" }}><div style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, color: T.accent, fontWeight: 700 }}>{ev.registered}</div><p style={{ fontSize: 11, color: "#6b7280" }}>of {ev.maxParticipants}</p></div>
              <CrudActions />
            </div>
          </div>
        </div>
...
function AdminPricingPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, color: "#1a1a22", margin: 0, fontWeight: 600 }}>Pricing & Memberships</h1><CrudBar addLabel="Add Tier" /></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: "#ffffff", border: `1px solid ${tier.popular ? T.accent : "#e5e7eb"}`, borderRadius: 12, padding: 18 }}>
            ...
            <h3 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 20, color: "#1a1a22", margin: "0 0 4px", fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 32, color: T.accent, fontWeight: 700 }}>${tier.price}<span style={{ fontSize: 14, color: "#6b7280", fontWeight: 400 }}> {tier.period}</span></div>
...
function AdminBroadcastPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, color: "#1a1a22", margin: 0, fontWeight: 600 }}>Broadcast</h1>
      <div style={{ background: "#ffffff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
        <h3 style={{ color: "#1a1a22", fontSize: 16, fontWeight: 700, margin: "0 0 12px" }}>New Broadcast</h3>
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <input placeholder="Title" style={{ padding: "10px 14px", background: "#f9fafb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a22", fontSize: 13, outline: "none" }} />
          <textarea value={message} onChange={e => setMessage(e.target.value)} placeholder="Message..." rows={4} style={{ padding: "10px 14px", background: "#f9fafb", border: "1px solid #e5e7eb", borderRadius: 8, color: "#1a1a22", fontSize: 13, outline: "none", resize: "vertical", fontFamily: "inherit" }} />
...
function AdminSettingsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 28, color: "#1a1a22", margin: 0, fontWeight: 600 }}>Studio Settings</h1>
        ...
        {!confirmed ? (
          <>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 24, margin: 0, color: T.text, fontWeight: 600 }}>Confirm Reservation</h2>
            ...
            <div style={{ background: T.bgDim, borderRadius: 14, padding: "18px 16px", marginBottom: 20 }}>
              ...
              <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}><MapPin size={16} color={T.textMuted} /><span style={{ fontSize: 14, color: T.text }}>3516 Fremont Pl N, Fremont</span></div>
              </div>
            </div>
            <div style={{ background: T.accentGhost, border: `1px solid ${T.accentBorder}`, borderRadius: 10, padding: "12px 14px", marginBottom: 20 }}>
              ...
              <p style={{ fontSize: 12, color: "#5a5040", margin: "0 0 4px", lineHeight: 1.4 }}>$7 late-cancel or no-show fee. Cancel at least 4 hours before class to avoid fees.</p>
              <p style={{ fontSize: 12, color: "#5a5040", margin: 0, lineHeight: 1.4 }}>Arrive on time. Late entry is not permitted. Room heated 80-98F..</p>
            </div>
            <button onClick={() => { setConfirmed(true); onConfirm(classData.id); }} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Darker Grotesque', serif", background: isFull ? T.success : T.accent, color: "#fff", marginBottom: 8 }}>{isFull ? "Join Waitlist" : "Confirm Reservation"}</button>
          ...
          <div style={{ textAlign: "center", padding: "10px 0" }}>
            ...
            <h2 style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 24, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{isFull ? "Added to Waitlist" : "You're In!"}</h2>
            ...
            <button onClick={onClose} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Darker Grotesque', serif", background: T.accent, color: "#fff" }}>Done</button>
          </div>
        )}
      </div>
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: T.bgCard, borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 390, maxHeight: "85vh", overflow: "auto", padding: "20px 20px 40px" }}>
        ...
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Darker Grotesque', serif", fontSize: 20, color: "#fff", fontWeight: 700 }}>JT</div>
            <div><p style={{ fontWeight: 700, margin: 0, fontSize: 15 }}>Jess Tanaka</p><p style={{ fontSize: 12, color: T.textMuted, margin: "2px 0 0" }}>Maven Unlimited — Since Aug 2024</p></div>
          </div>
        </div>
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
...
function NotificationsModal({ onClose }) {
  const notifications = [
    { id: 1, title: "Tomorrow: Flow + Mellow", message: "Best of both worlds. Flow then deep release with props. 75 min.", type: "class", time: "2 hours ago", read: false },
    { id: 2, title: "New Milestone!", message: "Alex M. reached 100 classes. Celebrate together!", type: "community", time: "4 hours ago", read: false },
    { id: 3, title: "Class Reminder", message: "Reserved for 8:00 AM Dynamic Power Flow with Ferrah.", type: "class", time: "6 hours ago", read: true },
    { id: 4, title: "Yoga School Collab TT", message: "200HR training with Maven and SOL. BIPOC spaces at 50% off.", type: "event", time: "1 day ago", read: true },
  ];
  return (
    <div onClick={onClose} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 100, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
...
export default function App({ onAdminChange }) {
  ...
  if (isAdmin) {
    return (
      <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
        <div style={{ display: "flex", height: "100vh", fontFamily: "'Figtree', system-ui, sans-serif", background: "#f3f4f6", position: "fixed", inset: 0, zIndex: 9999 }}>
          <aside style={{ width: 220, background: "#ffffff", color: "#1a1a22", display: "flex", flexDirection: "column", flexShrink: 0, borderRight: "1px solid #e5e7eb" }}>
            <div style={{ padding: "16px 14px", borderBottom: "1px solid #e5e7eb" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{ width: 32, height: 32, borderRadius: 8, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Darker Grotesque', serif", fontSize: 14, color: "#fff", fontWeight: 700 }}>M</div>
                <div><span style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 16, display: "block", lineHeight: 1, fontWeight: 600, color: "#1a1a22" }}>Maven Yoga</span><span style={{ fontSize: 8, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.15em" }}>Admin</span></div>
              </div>
            </div>
            <nav style={{ flex: 1, padding: "8px 6px", overflow: "auto" }}>
              {adminTabs.map(tab => {
                const active = page === tab.id;
                return <button key={tab.id} onClick={() => setPage(tab.id)} style={{ display: "flex", alignItems: "center", gap: 8, width: "100%", padding: "8px 10px", borderRadius: 8, border: "none", background: active ? `${T.accent}15` : "transparent", color: active ? T.accent : "#6b7280", fontSize: 12, fontWeight: active ? 600 : 400, cursor: "pointer", marginBottom: 2, textAlign: "left" }}><tab.icon size={16} /><span>{tab.label}</span></button>;
              })}
            </nav>
  ...
  return (
    <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
      <div style={{ display: "flex", flexDirection: "column", height: "100%", background: T.bgDim, fontFamily: "'Figtree', system-ui, sans-serif", position: "relative" }}>
        <header style={{ flexShrink: 0, background: T.bg, color: "#fff", padding: "10px 14px", display: "flex", alignItems: "center", justifyContent: "space-between", zIndex: 30 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ width: 34, height: 34, borderRadius: 8, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Darker Grotesque', serif", fontSize: 14, color: "#fff", fontWeight: 700 }}>{STUDIO_CONFIG.logoMark}</div>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 18, lineHeight: 1, fontWeight: 600 }}>{STUDIO_CONFIG.name}</span>
        ...
        {showMore && (
          <div onClick={() => setShowMore(false)} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 40 }}>
            <div onClick={e => e.stopPropagation()} style={{ position: "absolute", bottom: 68, left: 16, right: 16, background: T.bgCard, borderRadius: 16, padding: "14px 12px", boxShadow: "0 8px 32px rgba(0,0,0,.15)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 6px 8px" }}><span style={{ fontFamily: "'Darker Grotesque', serif", fontSize: 20, fontWeight: 600 }}>More</span><button onClick={() => setShowMore(false)} style={{ padding: 4, borderRadius: 6, border: "none", background: "transparent", cursor: "pointer" }}><X size={18} color={T.textMuted} /></button></div>
        ...
        <nav style={{ position: "sticky", bottom: 0, flexShrink: 0, background: T.bgCard, borderTop: `1px solid ${T.border}`, zIndex: 30 }}>
